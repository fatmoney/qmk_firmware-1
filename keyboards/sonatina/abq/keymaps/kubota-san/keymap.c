...
// https://www.reddit.com/r/olkb/comments/ghjkvl/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_mac(
      ...
      MT(MOD_LSFT, KC_DOT), KC_Z, KC_X,  KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH), \
      KKC_LGUI, C_ALGR, LT(1, KC_SPC), LT(2, KC_ENT), KC_CAPP, KC_CPYP \
    ),

    [1] = LAYOUT_mac(
      TD(GRV_TILD), KC_EXLM, KC_UP, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_LCBR, KC_RCBR, KC_PLUS, _______, KC_UNDS, \
      LCTL(KC_A), KC_LEFT, KC_DOWN, KC_DEL, KC_RIGHT, KC_SPC, KC_BSPC, KC_LPRN, KC_RPRN, KC_EQL, KC_COLN, KC_DQUO, \
      _______, KC_BSLS, KC_AT, KC_QUES, KC_AMPR, KC_PIPE, KC_LBRC, KC_RBRC, KC_LT, KC_GT, KC_ASTR, \
      _______, _______, _______, _______, _______, _______ \
    ),

    [2] = LAYOUT_mac(
      _______, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_0, \
      KC_DOT, _______, _______, _______, _______, _______, KC_BSPC, KC_PLUS, KC_MINUS, KC_ASTR, KC_SLSH, KC_CIRC,  \
      RESET, _______, _______, _______, _______, _______, KC_AMPR, KC_PIPE, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______ \
    ),
